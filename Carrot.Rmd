...
```{r}
# Loading Datasets.
veggies <- read_csv("C:/Users/chenj/Desktop/FM Groupwork/kalimati_tarkari_dataset.csv", 
                    col_types = cols(Date = col_date(format = "%Y-%m-%d")))

suppressWarnings({
  cpi <- read_excel("C:/Users/chenj/Desktop/FM Groupwork/Nepal CPI Trading Economics.xlsx", 
